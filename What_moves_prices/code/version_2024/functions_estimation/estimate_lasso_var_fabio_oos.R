estimate_lasso_var <- function(data, pen.search="Rolling", penalty.struct="BasicEN", lags=1, t1 = t1, t2 = t2,
  ...
  return(list(prediction=lasso.var.pred, best.hyper=best.hyperparam, coefMat=coef2, fitted = fitted, res_var = res_var))   
}
